...
function animate()
{
	...
	//MATH.POW MATH.SQRT
	if (Math.abs(Math.sqrt(Math.pow(pearl.x - player.x, 2) + Math.pow(pearl.y - player.y, 2))) <= 300) {
	pearl.x = pearl.x + -(pearl.x - player.x)*0.05;
	pearl.y = pearl.y + -(pearl.y - player.y)*0.05;
	}
	if (Math.abs(Math.sqrt(Math.pow(pearl.x - player.x, 2) + Math.pow(pearl.y - player.y, 2))) < 1 &&
	Math.abs(Math.sqrt(Math.pow(pearl.x - player.x, 2) + Math.pow(pearl.y - player.y, 2))) > 0) {
		pearl.x = -10000;
		pearl.y = -10000;
	}

	//console.log(Math.abs(Math.sqrt(Math.pow(pearl.x - player.x, 2) + Math.pow(pearl.y - player.y, 2))));
